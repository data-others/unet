...
| U-Net Studio Human Tissue Segmentation (13MB) | U-Net Studio template-based tissue segmentation model for human MRI (T1w,T2w,FLAIR...etc). | [human_tissue.nz](https://github.com/data-others/unet/releases/download/unet-studio/human_tissue.nz) |
...
| U-Net Studio Human MS Lesion V2 (13MB) | U-Net Studio template-based multiple sclerosis segmentation model for human MRI (T1w,T2w,FLAIR...etc). This model is intended for research workflows involving multiple sclerosis lesion segmentation. | [human_ms.nz](https://github.com/data-others/unet/releases/download/unet-studio/human_ms.nz) |
